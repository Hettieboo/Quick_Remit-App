  ...
  return (
    <div className="step-card">
      ...
      <div className="transfer-summary">
        ...
        <div className="summary-row">
          <span>Fee:</span>
          <span>{formData.sendCurrency} {formData.fee.toFixed(2)}</span>
        </div>
        <div className="summary-row">
          <span>Total:</span>
          <span className="amount">{formData.sendCurrency} {formData.totalToPay.toFixed(2)}</span>
        </div>
      ...
      <div className="button-group">
        ...
        >
          {processing ? (
            ...
            <>Pay {formData.sendCurrency} {formData.totalToPay.toFixed(2)}</>
          )}
        </button>
      </div>
